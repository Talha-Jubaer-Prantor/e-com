...
const Signup = () => {
    return (
        <div className='signup'>
            ...
            <div>
            <section style={{backgroundColor:"#8a2be2",paddingTop:"25px",paddingBottom:"25px"}}>
        <div class="card text-black signup-box" style={{borderRadius:"25px"}}>
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              ...
              <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  ...
                  {/* <img src="../../img/signup-img.png" alt="ouoi" /> */}
